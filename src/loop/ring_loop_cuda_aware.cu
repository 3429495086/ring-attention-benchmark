 ...
 * Pure communication benchmark using CUDA-aware MPI:
 *   device buffer -> MPI_Sendrecv -> device buffer
 *
 * Compile:
 *   nvcc -o ring_loop_cuda_aware ring_loop_cuda_aware.cu \
 ...
 *   -np 2 ./ring_loop_cuda_aware 262144 10 100
 */
